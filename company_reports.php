...
$stmt = $pdo->query("SELECT name FROM companies ORDER BY name");
...
<div class="overlay">
  <h1>Select a Company to View Reports</h1>
  <div class="grid-container">
    <?php foreach ($companies as $company): ?>
      <a class="company-card" href="company_dashboard.php?name=<?= urlencode($company['name']) ?>">
